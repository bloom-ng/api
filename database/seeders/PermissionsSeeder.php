...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list churches']);
        Permission::create(['name' => 'view churches']);
        Permission::create(['name' => 'create churches']);
        Permission::create(['name' => 'update churches']);
        Permission::create(['name' => 'delete churches']);
